    ...
    <div style={{ background: "#000000" }}>
      ...
      <section className="min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-16 xl:px-20">
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-12 lg:py-0">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative mt-9 w-full max-w-[350px] md:max-w-[350px] lg:max-w-[350px] animate-float transition-transform duration-500">
              <Image
                src="/hero.png"
      ...
      <section className="py-12 md:py-16 lg:py-20 px-6 md:px-12 lg:px-16 xl:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-white text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 agenda-font">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {activeTab === "customers" ? (
              <div className="space-y-8">
                <h3 className="text-white text-3xl md:text-4xl font-semibold agenda-font mb-8">
                  Why RIZZerv?
                </h3>
              ...
              <div className="space-y-8">
                ...
                <p className="text-white/80 text-sm md:text-base leading-relaxed mb-8">
                  Register & Unlock free trial of RIZZerv Dashboard
                </p>
      ...
      <section className="bg-black py-12 md:py-16 lg:py-20 px-6 md:px-12 lg:px-16 xl:px-20 relative overflow-hidden min-h-100 md:min-h-135 flex items-center justify-center">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-white font-semibold agenda-font mb-6">
            <span className="block text-4xl md:text-5xl lg:text-5xl leading-tight">
        ...
        <div className="absolute inset-0 max-w-7xl mx-auto pointer-events-none flex items-center justify-center">
          <div className="relative w-full h-full max-w-[1200px] max-h-[1200px]">
            {/* Top Left */}
            <div className="absolute left-[24%] md:left-[24%] animate-float">
              <Image
                src="/scissor.png"
                alt="Scissors"
                width={72}
            ...
            {/* Bottom Left */}
            <div className="absolute bottom-[9%] left-[31%] md:bottom-[9%] md:left-[31%] animate-float">
              <Image
                src="/Hairstyle.png"
                alt="Profile"
                width={72}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="bg-[#0B0B0B] rounded-t-[32px] p-8 lg:p-10 flex flex-col border-4 border-b-0 border-[#121212] overflow-hidden">
              ...
              {/* Phone Image - Overflowing */}
              <div className="flex-1 flex items-end justify-center -mb-20 lg:-mb-60">
            ...
            <div className="bg-[#0B0B0B] rounded-t-[32px] p-8 lg:p-10 flex flex-col border-4 border-b-0 border-[#121212] overflow-hidden">
              ...
              {/* Dashboard Image - Overflowing */}
              <div className="flex-1 flex justify-center -mb-20 lg:-mb-30">
